...
VENDOR_KEYWORDS = {
    ...
    "8086": ["Iris", "Graphics", "Meteor Lake", "Arrow Lake", "Lunar Lake"],
    "1002": ["Radeon", "Instinct", "FirePro", "Vega", "Audio", "Navi", "Aqua", "MI"],
    "15b3": ["ConnectX", "BlueField"],
}
...
PCI_JS_DATA = []
HEADERS = {
    "User-Agent": "Elemento/www.elemento.cloud/hello@elemento.cloud/AtomOS",
    ...
    for vendor_id, metadata in VENDOR_WATCHLIST.items():
        ...
        for line in data[limits[0] + 1 : limits[1]]:
            ...
            if match(r"\w", line):
                ...
                JS_VENDOR["models"].append({"name": desc, "id": mod})
